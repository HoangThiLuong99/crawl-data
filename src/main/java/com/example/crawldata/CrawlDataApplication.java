...
//
        Document doc = Jsoup.connect("https://giathuochapu.com/kinh-doanh-nha-thuoc-co-loi-khong/").get();
//        log(doc.title());

        Elements newsHeadlines = doc.select("#content #primary article header h1");
//        for (Element headline : newsHeadlines) {
//            log("%s\n\t%s", headline.attr("title"), headline.absUrl("href"));
//            String title = headline.absUrl("title");
        String url = newsHeadlines.text();
...
//        CrawlDataApplication obj = new CrawlDataApplication();
//
